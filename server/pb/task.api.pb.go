...
var file_task_api_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x12, 0x74, 0x61,
	0x73, 0x6b, 0x2e, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x32, 0xe1, 0x04, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x61, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x1c,
	0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31,
	...
	0x73, 0x6b, 0x12, 0x56, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6e, 0x6e,
	0x6f, 0x75, 0x6e, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x1c, 0x2e, 0x74, 0x61, 0x73, 0x6b,
	...
	0x73, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x68, 0x0a, 0x0c, 0x47, 0x65,
	0x74, 0x54, 0x61, 0x73, 0x6b, 0x47, 0x72, 0x61, 0x70, 0x68, 0x12, 0x1c, 0x2e, 0x74, 0x61, 0x73,
	...
	0x93, 0x02, 0x11, 0x12, 0x0f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x2f, 0x47,
	0x72, 0x61, 0x70, 0x68, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_task_api_proto_goTypes = []interface{}{
	...
	(*ListRequest)(nil),         // 3: task.service.v1.ListRequest
	(*HealthCheckResponse)(nil), // 4: task.service.v1.HealthCheckResponse
	(*SaveTaskResponse)(nil),    // 5: task.service.v1.SaveTaskResponse
	(*SetTaskResponse)(nil),     // 6: task.service.v1.SetTaskResponse
	(*ListTaskResponse)(nil),    // 7: task.service.v1.ListTaskResponse
}
var file_task_api_proto_depIdxs = []int32{
	...
	3, // 3: task.service.v1.TaskService.GetListTask:input_type -> task.service.v1.ListRequest
	3, // 4: task.service.v1.TaskService.GetListAnnouncement:input_type -> task.service.v1.ListRequest
	3, // 5: task.service.v1.TaskService.GetTaskGraph:input_type -> task.service.v1.ListRequest
	4, // 6: task.service.v1.TaskService.HealthCheck:output_type -> task.service.v1.HealthCheckResponse
	5, // 7: task.service.v1.TaskService.SaveTaskWithData:output_type -> task.service.v1.SaveTaskResponse
	6, // 8: task.service.v1.TaskService.SetTask:output_type -> task.service.v1.SetTaskResponse
	7, // 9: task.service.v1.TaskService.GetListTask:output_type -> task.service.v1.ListTaskResponse
	7, // 10: task.service.v1.TaskService.GetListAnnouncement:output_type -> task.service.v1.ListTaskResponse
	7, // 11: task.service.v1.TaskService.GetTaskGraph:output_type -> task.service.v1.ListTaskResponse
