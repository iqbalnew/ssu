...
var file_task_payload_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_task_payload_proto_goTypes = []interface{}{
	...
	(*Task)(nil),                // 9: task.service.v1.Task
}
var file_task_payload_proto_depIdxs = []int32{
	9, // 0: task.service.v1.SaveTaskRequest.task:type_name -> task.service.v1.Task
	9, // 1: task.service.v1.SetTaskResponse.data:type_name -> task.service.v1.Task
