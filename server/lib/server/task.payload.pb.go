...
var file_task_payload_proto_goTypes = []interface{}{
	...
	(*Task)(nil),                  // 25: task.service.v1.Task
	(Statuses)(0),                 // 26: task.service.v1.statuses
	(Steps)(0),                    // 27: task.service.v1.steps
}
var file_task_payload_proto_depIdxs = []int32{
	25, // 0: task.service.v1.SaveTaskRequest.task:type_name -> task.service.v1.Task
	25, // 1: task.service.v1.SetTaskResponse.data:type_name -> task.service.v1.Task
	25, // 2: task.service.v1.ListTaskRequest.task:type_name -> task.service.v1.Task
	0,  // 3: task.service.v1.ListTaskRequest.dir:type_name -> task.service.v1.ListTaskRequest.direction
	25, // 4: task.service.v1.ListTaskResponse.data:type_name -> task.service.v1.Task
	13, // 5: task.service.v1.ListTaskResponse.pagination:type_name -> task.service.v1.PaginationResponse
	26, // 6: task.service.v1.GraphStatusRequest.status:type_name -> task.service.v1.statuses
	26, // 7: task.service.v1.GraphStatus.status:type_name -> task.service.v1.statuses
	18, // 8: task.service.v1.GraphStatusResponse.data:type_name -> task.service.v1.GraphStatus
	27, // 9: task.service.v1.GraphStepRequest.step:type_name -> task.service.v1.steps
	26, // 10: task.service.v1.GraphStepRequest.status:type_name -> task.service.v1.statuses
	27, // 11: task.service.v1.GraphStep.step:type_name -> task.service.v1.steps
