...
var file_task_payload_proto_rawDesc = []byte{
	...
	0x22, 0x6d, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x75,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x04, 0x74, 0x61, 0x73, 0x6b, 0x12, 0x2f,
	0x0a, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17,
	...
	0x52, 0x07, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x22, 0x81, 0x01, 0x0a, 0x10, 0x4c, 0x69,
	...
	0x76, 0x31, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xa5, 0x01,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x6a, 0x0a, 0x0b, 0x47, 0x72, 0x61, 0x70, 0x68, 0x53, 0x74,
	...
	0xa5, 0x02, 0x0a, 0x10, 0x47, 0x72, 0x61, 0x70, 0x68, 0x53, 0x74, 0x65, 0x70, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x2a, 0x0a, 0x04, 0x73, 0x74, 0x65, 0x70, 0x18, 0x01, 0x20, 0x01,
	...
	0x74, 0x75, 0x73, 0x12, 0x5c, 0x0a, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x18, 0x03,
	...
	0x65, 0x12, 0x2a, 0x0a, 0x10, 0x69, 0x73, 0x49, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x41, 0x70,
	0x70, 0x72, 0x6f, 0x76, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x69, 0x73, 0x49,
	0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x12, 0x28, 0x0a,
	0x0f, 0x69, 0x73, 0x49, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x52, 0x65, 0x6a, 0x65, 0x63, 0x74,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x69, 0x73, 0x49, 0x6e, 0x63, 0x6c, 0x75, 0x64,
...
var file_task_payload_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_task_payload_proto_goTypes = []interface{}{
	...
	(*Search)(nil),              // 11: task.service.v1.Search
	(*ListTaskResponse)(nil),    // 12: task.service.v1.ListTaskResponse
	(*GraphStatusRequest)(nil),  // 13: task.service.v1.GraphStatusRequest
	(*GraphStatus)(nil),         // 14: task.service.v1.GraphStatus
	(*GraphStatusResponse)(nil), // 15: task.service.v1.GraphStatusResponse
	(*GraphStepRequest)(nil),    // 16: task.service.v1.GraphStepRequest
	(*GraphStep)(nil),           // 17: task.service.v1.GraphStep
	(*GraphStepResponse)(nil),   // 18: task.service.v1.GraphStepResponse
	(*Task)(nil),                // 19: task.service.v1.Task
	(Statuses)(0),               // 20: task.service.v1.statuses
	(Steps)(0),                  // 21: task.service.v1.steps
}
var file_task_payload_proto_depIdxs = []int32{
	19, // 0: task.service.v1.SaveTaskRequest.task:type_name -> task.service.v1.Task
	19, // 1: task.service.v1.SetTaskResponse.data:type_name -> task.service.v1.Task
	19, // 2: task.service.v1.ListTaskRequest.task:type_name -> task.service.v1.Task
	11, // 3: task.service.v1.ListTaskRequest.search:type_name -> task.service.v1.Search
	19, // 4: task.service.v1.ListTaskResponse.data:type_name -> task.service.v1.Task
	20, // 5: task.service.v1.GraphStatusRequest.status:type_name -> task.service.v1.statuses
	20, // 6: task.service.v1.GraphStatus.status:type_name -> task.service.v1.statuses
	14, // 7: task.service.v1.GraphStatusResponse.data:type_name -> task.service.v1.GraphStatus
	21, // 8: task.service.v1.GraphStepRequest.step:type_name -> task.service.v1.steps
	20, // 9: task.service.v1.GraphStepRequest.status:type_name -> task.service.v1.statuses
	21, // 10: task.service.v1.GraphStep.step:type_name -> task.service.v1.steps
	17, // 11: task.service.v1.GraphStepResponse.data:type_name -> task.service.v1.GraphStep
