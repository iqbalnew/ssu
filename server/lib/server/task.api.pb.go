...
var file_task_api_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xc8, 0x19, 0x0a, 0x0b,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x91, 0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x17, 0x1a,
	...
	0x94, 0x01, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1a, 0x1a, 0x15, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x74,
	...
	0x67, 0x67, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x92, 0x41, 0x00, 0x12, 0x5a, 0x0a, 0x0e, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x44, 0x61, 0x74, 0x61, 0x12, 0x22, 0x2e, 0x74,
	0x61, 0x73, 0x6b, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x55,
	...
	0x61, 0x52, 0x65, 0x73, 0x22, 0x00, 0x42, 0xaf, 0x01, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x92,
...
var file_task_api_proto_goTypes = []interface{}{
	...
	(*UpdateTaskDataReq)(nil),              // 21: task.service.v1.UpdateTaskDataReq
	(*SaveTaskResponse)(nil),               // 22: task.service.v1.SaveTaskResponse
	(*SaveTaskResponseEV)(nil),             // 23: task.service.v1.SaveTaskResponseEV
	(*SetTaskResponse)(nil),                // 24: task.service.v1.SetTaskResponse
	(*SetTaskResponseEV)(nil),              // 25: task.service.v1.SetTaskResponseEV
	(*ListTaskResponse)(nil),               // 26: task.service.v1.ListTaskResponse
	(*ListTaskPluckResponse)(nil),          // 27: task.service.v1.ListTaskPluckResponse
	(*ListTaskResponseEV)(nil),             // 28: task.service.v1.ListTaskResponseEV
	...
	(*AssignaTypeIDResponse)(nil),          // 32: task.service.v1.AssignaTypeIDResponse
	(*GetTaskByIDRes)(nil),                 // 33: task.service.v1.GetTaskByIDRes
	(*GetTaskByTypeIDRes)(nil),             // 34: task.service.v1.GetTaskByTypeIDRes
	(*RejectBySystemRes)(nil),              // 35: task.service.v1.RejectBySystemRes
	(*GetActivityLogsRes)(nil),             // 36: task.service.v1.GetActivityLogsRes
	(*httpbody.HttpBody)(nil),              // 37: google.api.HttpBody
	(*UpdateTaskDataRes)(nil),              // 38: task.service.v1.UpdateTaskDataRes
}
var file_task_api_proto_depIdxs = []int32{
	...
	13, // 13: task.service.v1.TaskService.GetListAnnouncement:input_type -> task.service.v1.ListRequest
	14, // 14: task.service.v1.TaskService.AssignTypeID:input_type -> task.service.v1.AssignaTypeIDRequest
	15, // 15: task.service.v1.TaskService.AssignTypeIDEV:input_type -> task.service.v1.AssignaTypeIDRequestEV
	16, // 16: task.service.v1.TaskService.GetTaskByID:input_type -> task.service.v1.GetTaskByIDReq
	17, // 17: task.service.v1.TaskService.GetTaskByTypeID:input_type -> task.service.v1.GetTaskByTypeIDReq
	18, // 18: task.service.v1.TaskService.RejectBySystem:input_type -> task.service.v1.RejectBySystemReq
	19, // 19: task.service.v1.TaskService.GetActivityLogs:input_type -> task.service.v1.GetActivityLogsReq
	20, // 20: task.service.v1.TaskService.DownloadActivityLogs:input_type -> task.service.v1.DownloadActivityLogsReq
	0,  // 21: task.service.v1.TaskService.TestLogger:input_type -> task.service.v1.LoggerTestReq
	21, // 22: task.service.v1.TaskService.UpdateTaskData:input_type -> task.service.v1.UpdateTaskDataReq
	22, // 23: task.service.v1.TaskService.SaveTaskWithData:output_type -> task.service.v1.SaveTaskResponse
	23, // 24: task.service.v1.TaskService.SaveTaskWithDataEV:output_type -> task.service.v1.SaveTaskResponseEV
	22, // 25: task.service.v1.TaskService.GenerateTaskWithWokflow:output_type -> task.service.v1.SaveTaskResponse
	22, // 26: task.service.v1.TaskService.SaveTaskWithWorkflow:output_type -> task.service.v1.SaveTaskResponse
	24, // 27: task.service.v1.TaskService.SetTask:output_type -> task.service.v1.SetTaskResponse
	25, // 28: task.service.v1.TaskService.SetTaskEV:output_type -> task.service.v1.SetTaskResponseEV
	26, // 29: task.service.v1.TaskService.GetListTaskWithToken:output_type -> task.service.v1.ListTaskResponse
	26, // 30: task.service.v1.TaskService.GetListTask:output_type -> task.service.v1.ListTaskResponse
	27, // 31: task.service.v1.TaskService.GetListTaskPluck:output_type -> task.service.v1.ListTaskPluckResponse
	28, // 32: task.service.v1.TaskService.GetListTaskEV:output_type -> task.service.v1.ListTaskResponseEV
	29, // 33: task.service.v1.TaskService.GetTaskGraphStatus:output_type -> task.service.v1.GraphStatusResponse
	30, // 34: task.service.v1.TaskService.GraphStatusColumnType:output_type -> task.service.v1.GraphStatusColumnTypeResponse
	31, // 35: task.service.v1.TaskService.GetTaskGraphStep:output_type -> task.service.v1.GraphStepResponse
	26, // 36: task.service.v1.TaskService.GetListAnnouncement:output_type -> task.service.v1.ListTaskResponse
	32, // 37: task.service.v1.TaskService.AssignTypeID:output_type -> task.service.v1.AssignaTypeIDResponse
	32, // 38: task.service.v1.TaskService.AssignTypeIDEV:output_type -> task.service.v1.AssignaTypeIDResponse
	33, // 39: task.service.v1.TaskService.GetTaskByID:output_type -> task.service.v1.GetTaskByIDRes
	34, // 40: task.service.v1.TaskService.GetTaskByTypeID:output_type -> task.service.v1.GetTaskByTypeIDRes
	35, // 41: task.service.v1.TaskService.RejectBySystem:output_type -> task.service.v1.RejectBySystemRes
	36, // 42: task.service.v1.TaskService.GetActivityLogs:output_type -> task.service.v1.GetActivityLogsRes
	37, // 43: task.service.v1.TaskService.DownloadActivityLogs:output_type -> google.api.HttpBody
	1,  // 44: task.service.v1.TaskService.TestLogger:output_type -> task.service.v1.LoggerTestRes
	38, // 45: task.service.v1.TaskService.UpdateTaskData:output_type -> task.service.v1.UpdateTaskDataRes
