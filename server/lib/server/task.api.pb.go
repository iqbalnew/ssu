...
var file_task_api_proto_rawDesc = []byte{
	...
	0x32, 0xe5, 0x04, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	,
	...
	0x17, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x11, 0x12, 0x0f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x74, 0x61,
	0x73, 0x6b, 0x2f, 0x47, 0x72, 0x61, 0x70, 0x68, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62,
...
var file_task_api_proto_goTypes = []interface{}{
	...
	(*ListRequest)(nil),         // 4: task.service.v1.ListRequest
	(*HealthCheckResponse)(nil), // 5: task.service.v1.HealthCheckResponse
	(*SaveTaskResponse)(nil),    // 6: task.service.v1.SaveTaskResponse
	(*SetTaskResponse)(nil),     // 7: task.service.v1.SetTaskResponse
	(*ListTaskResponse)(nil),    // 8: task.service.v1.ListTaskResponse
}
var file_task_api_proto_depIdxs = []int32{
	...
	4, // 4: task.service.v1.TaskService.GetListAnnouncement:input_type -> task.service.v1.ListRequest
	4, // 5: task.service.v1.TaskService.GetTaskGraph:input_type -> task.service.v1.ListRequest
	5, // 6: task.service.v1.TaskService.HealthCheck:output_type -> task.service.v1.HealthCheckResponse
	6, // 7: task.service.v1.TaskService.SaveTaskWithData:output_type -> task.service.v1.SaveTaskResponse
	7, // 8: task.service.v1.TaskService.SetTask:output_type -> task.service.v1.SetTaskResponse
	8, // 9: task.service.v1.TaskService.GetListTask:output_type -> task.service.v1.ListTaskResponse
	8, // 10: task.service.v1.TaskService.GetListAnnouncement:output_type -> task.service.v1.ListTaskResponse
	8, // 11: task.service.v1.TaskService.GetTaskGraph:output_type -> task.service.v1.ListTaskResponse
