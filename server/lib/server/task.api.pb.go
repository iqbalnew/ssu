...
var file_task_api_proto_rawDesc = []byte{
	...
	0x32, 0xcf, 0x07, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x78, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x54,
	...
	0x49, 0x44, 0x52, 0x65, 0x73, 0x22, 0x1b, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x15, 0x12, 0x13, 0x2f,
	0x61, 0x70, 0x69, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x2f, 0x7b, 0x49,
	0x44, 0x7d, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_task_api_proto_goTypes = []interface{}{
	...
	(*HealthCheckResponse)(nil),   // 9: task.service.v1.HealthCheckResponse
	(*SaveTaskResponse)(nil),      // 10: task.service.v1.SaveTaskResponse
	(*SetTaskResponse)(nil),       // 11: task.service.v1.SetTaskResponse
	(*ListTaskResponse)(nil),      // 12: task.service.v1.ListTaskResponse
	(*GraphStatusResponse)(nil),   // 13: task.service.v1.GraphStatusResponse
...
var file_task_api_proto_depIdxs = []int32{
	...
	9,  // 9: task.service.v1.TaskService.HealthCheck:output_type -> task.service.v1.HealthCheckResponse
	10, // 10: task.service.v1.TaskService.SaveTaskWithData:output_type -> task.service.v1.SaveTaskResponse
	11, // 11: task.service.v1.TaskService.SetTask:output_type -> task.service.v1.SetTaskResponse
	12, // 12: task.service.v1.TaskService.GetListTask:output_type -> task.service.v1.ListTaskResponse
	13, // 13: task.service.v1.TaskService.GetTaskGraphStatus:output_type -> task.service.v1.GraphStatusResponse
	14, // 14: task.service.v1.TaskService.GetTaskGraphStep:output_type -> task.service.v1.GraphStepResponse
	12, // 15: task.service.v1.TaskService.GetListAnnouncement:output_type -> task.service.v1.ListTaskResponse
