...
var file_task_api_proto_rawDesc = []byte{
	...
	0x32, 0xe3, 0x04, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x69, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x12, 0x66, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x54, 0x61, 0x73,
	0x6b, 0x47, 0x72, 0x61, 0x70, 0x68, 0x12, 0x1d, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x72, 0x61, 0x70, 0x68, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x72, 0x61, 0x70, 0x68, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x17, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x11, 0x12, 0x0f, 0x2f,
	0x61, 0x70, 0x69, 0x2f, 0x74, 0x61, 0x73, 0x6b, 0x2f, 0x67, 0x72, 0x61, 0x70, 0x68, 0x12, 0x56,
...
var file_task_api_proto_goTypes = []interface{}{
	...
	(*GraphRequest)(nil),        // 4: task.service.v1.GraphRequest
	(*ListRequest)(nil),         // 5: task.service.v1.ListRequest
	(*HealthCheckResponse)(nil), // 6: task.service.v1.HealthCheckResponse
	(*SaveTaskResponse)(nil),    // 7: task.service.v1.SaveTaskResponse
	(*SetTaskResponse)(nil),     // 8: task.service.v1.SetTaskResponse
	(*ListTaskResponse)(nil),    // 9: task.service.v1.ListTaskResponse
	(*GraphResponse)(nil),       // 10: task.service.v1.GraphResponse
}
var file_task_api_proto_depIdxs = []int32{
	...
	4,  // 4: task.service.v1.TaskService.GetTaskGraph:input_type -> task.service.v1.GraphRequest
	5,  // 5: task.service.v1.TaskService.GetListAnnouncement:input_type -> task.service.v1.ListRequest
	6,  // 6: task.service.v1.TaskService.HealthCheck:output_type -> task.service.v1.HealthCheckResponse
	7,  // 7: task.service.v1.TaskService.SaveTaskWithData:output_type -> task.service.v1.SaveTaskResponse
	8,  // 8: task.service.v1.TaskService.SetTask:output_type -> task.service.v1.SetTaskResponse
	9,  // 9: task.service.v1.TaskService.GetListTask:output_type -> task.service.v1.ListTaskResponse
	10, // 10: task.service.v1.TaskService.GetTaskGraph:output_type -> task.service.v1.GraphResponse
	9,  // 11: task.service.v1.TaskService.GetListAnnouncement:output_type -> task.service.v1.ListTaskResponse
