...
var file_task_api_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xd4, 0x1c, 0x0a, 0x0b,
	...
	0x6b, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x22, 0x00, 0x12, 0x56, 0x0a, 0x0d, 0x55, 0x70,
	...
	0x22, 0x00, 0x42, 0xaf, 0x01, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x92, 0x41, 0xa5, 0x01, 0x12,
	0x13, 0x0a, 0x0c, 0x54, 0x61, 0x73, 0x6b, 0x20, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x32,
...
var file_task_api_proto_goTypes = []interface{}{
	...
	(*UpdateTaskRawReq)(nil),                          // 23: task.service.v1.UpdateTaskRawReq
	(*SaveTaskResponse)(nil),                          // 24: task.service.v1.SaveTaskResponse
	(*SaveTaskResponseEV)(nil),                        // 25: task.service.v1.SaveTaskResponseEV
	(*SetTaskResponse)(nil),                           // 26: task.service.v1.SetTaskResponse
	(*SetTaskResponseEV)(nil),                         // 27: task.service.v1.SetTaskResponseEV
	(*ListTaskResponse)(nil),                          // 28: task.service.v1.ListTaskResponse
	(*ListTaskPluckResponse)(nil),                     // 29: task.service.v1.ListTaskPluckResponse
	(*ListTaskResponseEV)(nil),                        // 30: task.service.v1.ListTaskResponseEV
	...
	(*GraphStepResponse)(nil),                         // 33: task.service.v1.GraphStepResponse
	(*GetMyPendingTaskWithWorkflowGraphResponse)(nil), // 34: task.service.v1.GetMyPendingTaskWithWorkflowGraphResponse
	(*AssignaTypeIDResponse)(nil),                     // 35: task.service.v1.AssignaTypeIDResponse
	(*GetTaskByIDRes)(nil),                            // 36: task.service.v1.GetTaskByIDRes
	(*GetTaskByTypeIDRes)(nil),                        // 37: task.service.v1.GetTaskByTypeIDRes
	(*RejectBySystemRes)(nil),                         // 38: task.service.v1.RejectBySystemRes
	(*GetActivityLogsRes)(nil),                        // 39: task.service.v1.GetActivityLogsRes
	(*httpbody.HttpBody)(nil),                         // 40: google.api.HttpBody
	(*UpdateTaskDataRes)(nil),                         // 41: task.service.v1.UpdateTaskDataRes
}
var file_task_api_proto_depIdxs = []int32{
	...
	23, // 24: task.service.v1.TaskService.UpdateTaskRaw:input_type -> task.service.v1.UpdateTaskRawReq
	24, // 25: task.service.v1.TaskService.SaveTaskWithData:output_type -> task.service.v1.SaveTaskResponse
	25, // 26: task.service.v1.TaskService.SaveTaskWithDataEV:output_type -> task.service.v1.SaveTaskResponseEV
	24, // 27: task.service.v1.TaskService.GenerateTaskWithWokflow:output_type -> task.service.v1.SaveTaskResponse
	24, // 28: task.service.v1.TaskService.SaveTaskWithWorkflow:output_type -> task.service.v1.SaveTaskResponse
	26, // 29: task.service.v1.TaskService.SetTask:output_type -> task.service.v1.SetTaskResponse
	27, // 30: task.service.v1.TaskService.SetTaskEV:output_type -> task.service.v1.SetTaskResponseEV
	28, // 31: task.service.v1.TaskService.GetListTaskWithToken:output_type -> task.service.v1.ListTaskResponse
	28, // 32: task.service.v1.TaskService.GetListTask:output_type -> task.service.v1.ListTaskResponse
	29, // 33: task.service.v1.TaskService.GetListTaskPluck:output_type -> task.service.v1.ListTaskPluckResponse
	30, // 34: task.service.v1.TaskService.GetListTaskEV:output_type -> task.service.v1.ListTaskResponseEV
	31, // 35: task.service.v1.TaskService.GetTaskGraphStatus:output_type -> task.service.v1.GraphStatusResponse
	32, // 36: task.service.v1.TaskService.GraphStatusColumnType:output_type -> task.service.v1.GraphStatusColumnTypeResponse
	33, // 37: task.service.v1.TaskService.GetTaskGraphStep:output_type -> task.service.v1.GraphStepResponse
	34, // 38: task.service.v1.TaskService.GetMyPendingTaskWithWorkflowGraph:output_type -> task.service.v1.GetMyPendingTaskWithWorkflowGraphResponse
	28, // 39: task.service.v1.TaskService.GetListAnnouncement:output_type -> task.service.v1.ListTaskResponse
	35, // 40: task.service.v1.TaskService.AssignTypeID:output_type -> task.service.v1.AssignaTypeIDResponse
	35, // 41: task.service.v1.TaskService.AssignTypeIDEV:output_type -> task.service.v1.AssignaTypeIDResponse
	36, // 42: task.service.v1.TaskService.GetTaskByID:output_type -> task.service.v1.GetTaskByIDRes
	37, // 43: task.service.v1.TaskService.GetTaskByTypeID:output_type -> task.service.v1.GetTaskByTypeIDRes
	38, // 44: task.service.v1.TaskService.RejectBySystem:output_type -> task.service.v1.RejectBySystemRes
	39, // 45: task.service.v1.TaskService.GetActivityLogs:output_type -> task.service.v1.GetActivityLogsRes
	40, // 46: task.service.v1.TaskService.DownloadActivityLogs:output_type -> google.api.HttpBody
	1,  // 47: task.service.v1.TaskService.TestLogger:output_type -> task.service.v1.LoggerTestRes
	41, // 48: task.service.v1.TaskService.UpdateTaskData:output_type -> task.service.v1.UpdateTaskDataRes
	26, // 49: task.service.v1.TaskService.UpdateTaskRaw:output_type -> task.service.v1.SetTaskResponse
