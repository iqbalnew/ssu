...
var file_task_api_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xbc, 0x1d, 0x0a, 0x0b,
	...
	,
...
var file_task_api_proto_goTypes = []interface{}{
	...
	(*SaveTaskResponse)(nil),                          // 25: task.service.v1.SaveTaskResponse
	(*SaveTaskResponseEV)(nil),                        // 26: task.service.v1.SaveTaskResponseEV
	(*SetTaskResponse)(nil),                           // 27: task.service.v1.SetTaskResponse
	(*SetTaskResponseEV)(nil),                         // 28: task.service.v1.SetTaskResponseEV
	(*ListTaskResponse)(nil),                          // 29: task.service.v1.ListTaskResponse
	(*ListTaskPluckResponse)(nil),                     // 30: task.service.v1.ListTaskPluckResponse
	(*ListTaskResponseEV)(nil),                        // 31: task.service.v1.ListTaskResponseEV
	(*GraphStatusResponse)(nil),                       // 32: task.service.v1.GraphStatusResponse
	(*GraphStatusColumnTypeResponse)(nil),             // 33: task.service.v1.GraphStatusColumnTypeResponse
	(*GraphStepResponse)(nil),                         // 34: task.service.v1.GraphStepResponse
	(*GetMyPendingTaskWithWorkflowGraphResponse)(nil), // 35: task.service.v1.GetMyPendingTaskWithWorkflowGraphResponse
	(*AssignaTypeIDResponse)(nil),                     // 36: task.service.v1.AssignaTypeIDResponse
	(*GetTaskByIDRes)(nil),                            // 37: task.service.v1.GetTaskByIDRes
	(*GetTaskByTypeIDRes)(nil),                        // 38: task.service.v1.GetTaskByTypeIDRes
	(*RejectBySystemRes)(nil),                         // 39: task.service.v1.RejectBySystemRes
	(*GetActivityLogsRes)(nil),                        // 40: task.service.v1.GetActivityLogsRes
	(*httpbody.HttpBody)(nil),                         // 41: google.api.HttpBody
	(*UpdateTaskDataRes)(nil),                         // 42: task.service.v1.UpdateTaskDataRes
	(*UpdateTaskWorkflowRes)(nil),                     // 43: task.service.v1.UpdateTaskWorkflowRes
}
var file_task_api_proto_depIdxs = []int32{
	...
	23, // 24: task.service.v1.TaskService.UpdateTaskWorkflow:input_type -> task.service.v1.UpdateTaskWorkflowReq
	24, // 25: task.service.v1.TaskService.UpdateTaskRaw:input_type -> task.service.v1.UpdateTaskRawReq
	25, // 26: task.service.v1.TaskService.SaveTaskWithData:output_type -> task.service.v1.SaveTaskResponse
	26, // 27: task.service.v1.TaskService.SaveTaskWithDataEV:output_type -> task.service.v1.SaveTaskResponseEV
	25, // 28: task.service.v1.TaskService.GenerateTaskWithWokflow:output_type -> task.service.v1.SaveTaskResponse
	25, // 29: task.service.v1.TaskService.SaveTaskWithWorkflow:output_type -> task.service.v1.SaveTaskResponse
	27, // 30: task.service.v1.TaskService.SetTask:output_type -> task.service.v1.SetTaskResponse
	28, // 31: task.service.v1.TaskService.SetTaskEV:output_type -> task.service.v1.SetTaskResponseEV
	29, // 32: task.service.v1.TaskService.GetListTaskWithToken:output_type -> task.service.v1.ListTaskResponse
	29, // 33: task.service.v1.TaskService.GetListTask:output_type -> task.service.v1.ListTaskResponse
	30, // 34: task.service.v1.TaskService.GetListTaskPluck:output_type -> task.service.v1.ListTaskPluckResponse
	31, // 35: task.service.v1.TaskService.GetListTaskEV:output_type -> task.service.v1.ListTaskResponseEV
	32, // 36: task.service.v1.TaskService.GetTaskGraphStatus:output_type -> task.service.v1.GraphStatusResponse
	33, // 37: task.service.v1.TaskService.GraphStatusColumnType:output_type -> task.service.v1.GraphStatusColumnTypeResponse
	34, // 38: task.service.v1.TaskService.GetTaskGraphStep:output_type -> task.service.v1.GraphStepResponse
	35, // 39: task.service.v1.TaskService.GetMyPendingTaskWithWorkflowGraph:output_type -> task.service.v1.GetMyPendingTaskWithWorkflowGraphResponse
	29, // 40: task.service.v1.TaskService.GetListAnnouncement:output_type -> task.service.v1.ListTaskResponse
	36, // 41: task.service.v1.TaskService.AssignTypeID:output_type -> task.service.v1.AssignaTypeIDResponse
	36, // 42: task.service.v1.TaskService.AssignTypeIDEV:output_type -> task.service.v1.AssignaTypeIDResponse
	37, // 43: task.service.v1.TaskService.GetTaskByID:output_type -> task.service.v1.GetTaskByIDRes
	38, // 44: task.service.v1.TaskService.GetTaskByTypeID:output_type -> task.service.v1.GetTaskByTypeIDRes
	39, // 45: task.service.v1.TaskService.RejectBySystem:output_type -> task.service.v1.RejectBySystemRes
	40, // 46: task.service.v1.TaskService.GetActivityLogs:output_type -> task.service.v1.GetActivityLogsRes
	41, // 47: task.service.v1.TaskService.DownloadActivityLogs:output_type -> google.api.HttpBody
	1,  // 48: task.service.v1.TaskService.TestLogger:output_type -> task.service.v1.LoggerTestRes
	42, // 49: task.service.v1.TaskService.UpdateTaskData:output_type -> task.service.v1.UpdateTaskDataRes
	43, // 50: task.service.v1.TaskService.UpdateTaskWorkflow:output_type -> task.service.v1.UpdateTaskWorkflowRes
	27, // 51: task.service.v1.TaskService.UpdateTaskRaw:output_type -> task.service.v1.SetTaskResponse
