...
var file_task_api_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xec, 0x18, 0x0a, 0x0b,
...
var file_task_api_proto_depIdxs = []int32{
	...
	21, // 22: task.service.v1.TaskService.SaveTaskWithData:output_type -> task.service.v1.SaveTaskResponse
	22, // 23: task.service.v1.TaskService.SaveTaskWithDataEV:output_type -> task.service.v1.SaveTaskResponseEV
	21, // 24: task.service.v1.TaskService.GenerateTaskWithWokflow:output_type -> task.service.v1.SaveTaskResponse
	21, // 25: task.service.v1.TaskService.SaveTaskWithWorkflow:output_type -> task.service.v1.SaveTaskResponse
	23, // 26: task.service.v1.TaskService.SetTask:output_type -> task.service.v1.SetTaskResponse
	24, // 27: task.service.v1.TaskService.SetTaskEV:output_type -> task.service.v1.SetTaskResponseEV
	25, // 28: task.service.v1.TaskService.GetListTaskWithToken:output_type -> task.service.v1.ListTaskResponse
	25, // 29: task.service.v1.TaskService.GetListTask:output_type -> task.service.v1.ListTaskResponse
	26, // 30: task.service.v1.TaskService.GetListTaskPluck:output_type -> task.service.v1.ListTaskPluckResponse
	27, // 31: task.service.v1.TaskService.GetListTaskEV:output_type -> task.service.v1.ListTaskResponseEV
	28, // 32: task.service.v1.TaskService.GetTaskGraphStatus:output_type -> task.service.v1.GraphStatusResponse
	29, // 33: task.service.v1.TaskService.GraphStatusColumnType:output_type -> task.service.v1.GraphStatusColumnTypeResponse
	30, // 34: task.service.v1.TaskService.GetTaskGraphStep:output_type -> task.service.v1.GraphStepResponse
	25, // 35: task.service.v1.TaskService.GetListAnnouncement:output_type -> task.service.v1.ListTaskResponse
	31, // 36: task.service.v1.TaskService.AssignTypeID:output_type -> task.service.v1.AssignaTypeIDResponse
	31, // 37: task.service.v1.TaskService.AssignTypeIDEV:output_type -> task.service.v1.AssignaTypeIDResponse
	32, // 38: task.service.v1.TaskService.GetTaskByID:output_type -> task.service.v1.GetTaskByIDRes
	33, // 39: task.service.v1.TaskService.GetTaskByTypeID:output_type -> task.service.v1.GetTaskByTypeIDRes
	34, // 40: task.service.v1.TaskService.RejectBySystem:output_type -> task.service.v1.RejectBySystemRes
	35, // 41: task.service.v1.TaskService.GetActivityLogs:output_type -> task.service.v1.GetActivityLogsRes
	36, // 42: task.service.v1.TaskService.DownloadActivityLogs:output_type -> google.api.HttpBody
	1,  // 43: task.service.v1.TaskService.TestLogger:output_type -> task.service.v1.LoggerTestRes
