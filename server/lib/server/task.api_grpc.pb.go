...
type TaskServiceClient interface {
	...
	SetTaskWithWorkflow(ctx context.Context, in *SetTaskWithWorkflowRequest, opts ...grpc.CallOption) (*SetTaskResponse, error)
	SetTaskEV(ctx context.Context, in *SetTaskRequestEV, opts ...grpc.CallOption) (*SetTaskResponseEV, error)
	GetListTaskWithToken(ctx context.Context, in *ListTaskRequest, opts ...grpc.CallOption) (*ListTaskWithTokenResponse, error)
	...
	DeleteDraftTask(ctx context.Context, in *DeleteDraftTaskRequest, opts ...grpc.CallOption) (*DeleteDraftTaskResponse, error)
}
...
func (c *taskServiceClient) SetTaskWithWorkflow(ctx context.Context, in *SetTaskWithWorkflowRequest, opts ...grpc.CallOption) (*SetTaskResponse, error) {
	out := new(SetTaskResponse)
...
func (c *taskServiceClient) GetListTaskWithToken(ctx context.Context, in *ListTaskRequest, opts ...grpc.CallOption) (*ListTaskWithTokenResponse, error) {
	out := new(ListTaskWithTokenResponse)
...
func (c *taskServiceClient) DeleteDraftTask(ctx context.Context, in *DeleteDraftTaskRequest, opts ...grpc.CallOption) (*DeleteDraftTaskResponse, error) {
	out := new(DeleteDraftTaskResponse)
	err := c.cc.Invoke(ctx, "/task.service.v1.TaskService/DeleteDraftTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	SetTaskWithWorkflow(context.Context, *SetTaskWithWorkflowRequest) (*SetTaskResponse, error)
	SetTaskEV(context.Context, *SetTaskRequestEV) (*SetTaskResponseEV, error)
	GetListTaskWithToken(context.Context, *ListTaskRequest) (*ListTaskWithTokenResponse, error)
	...
	DeleteDraftTask(context.Context, *DeleteDraftTaskRequest) (*DeleteDraftTaskResponse, error)
...
func (UnimplementedTaskServiceServer) SetTaskWithWorkflow(context.Context, *SetTaskWithWorkflowRequest) (*SetTaskResponse, error) {
...
func (UnimplementedTaskServiceServer) GetListTaskWithToken(context.Context, *ListTaskRequest) (*ListTaskWithTokenResponse, error) {
...
func (UnimplementedTaskServiceServer) DeleteDraftTask(context.Context, *DeleteDraftTaskRequest) (*DeleteDraftTaskResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteDraftTask not implemented")
}
...
func _TaskService_SetTaskWithWorkflow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetTaskWithWorkflowRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).SetTaskWithWorkflow(ctx, req.(*SetTaskWithWorkflowRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TaskService_DeleteDraftTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteDraftTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).DeleteDraftTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/task.service.v1.TaskService/DeleteDraftTask",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).DeleteDraftTask(ctx, req.(*DeleteDraftTaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteDraftTask",
			Handler:    _TaskService_DeleteDraftTask_Handler,
		},
	},
