...
type ApiServiceClient interface {
	...
	DeleteLiquidityTask(ctx context.Context, in *DeleteLiquidityTaskRequest, opts ...grpc.CallOption) (*DeleteTaskLiquidityResponse, error)
...
func (c *apiServiceClient) DeleteLiquidityTask(ctx context.Context, in *DeleteLiquidityTaskRequest, opts ...grpc.CallOption) (*DeleteTaskLiquidityResponse, error) {
	out := new(DeleteTaskLiquidityResponse)
...
type ApiServiceServer interface {
	...
	DeleteLiquidityTask(context.Context, *DeleteLiquidityTaskRequest) (*DeleteTaskLiquidityResponse, error)
...
func (UnimplementedApiServiceServer) DeleteLiquidityTask(context.Context, *DeleteLiquidityTaskRequest) (*DeleteTaskLiquidityResponse, error) {
...
func _ApiService_DeleteLiquidityTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteLiquidityTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServiceServer).DeleteLiquidityTask(ctx, req.(*DeleteLiquidityTaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
