...
type ApiServiceClient interface {
	...
	DeleteAnnouncement(ctx context.Context, in *CreateAnnouncementRequest, opts ...grpc.CallOption) (*DeleteAnnouncementResponse, error)
...
func (c *apiServiceClient) DeleteAnnouncement(ctx context.Context, in *CreateAnnouncementRequest, opts ...grpc.CallOption) (*DeleteAnnouncementResponse, error) {
...
type ApiServiceServer interface {
	...
	DeleteAnnouncement(context.Context, *CreateAnnouncementRequest) (*DeleteAnnouncementResponse, error)
...
func (UnimplementedApiServiceServer) DeleteAnnouncement(context.Context, *CreateAnnouncementRequest) (*DeleteAnnouncementResponse, error) {
