...
var file_user_api_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x46, 0x72, 0x65, 0x73, 0x68, 0x42, 0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x67, 0x32, 0xa1,
	0x19, 0x0a, 0x0a, 0x41, 0x70, 0x69, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x9a, 0x01,
	...
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0xc6, 0x01, 0x0a, 0x0e, 0x43,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x6b, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x31, 0x22, 0x0e,
	...
	0x41, 0x31, 0x12, 0x0f, 0x53, 0x61, 0x76, 0x65, 0x20, 0x75, 0x73, 0x65, 0x72, 0x73, 0x20, 0x74,
	...
	0x6b, 0x62, 0x00, 0x12, 0x4c, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x55, 0x73, 0x65,
...
var file_user_api_proto_goTypes = []interface{}{
	...
	(*GetTaskByIDReq)(nil),                    // 10: user.service.v1.GetTaskByIDReq
	(*CreateUserRequest)(nil),                 // 11: user.service.v1.CreateUserRequest
	(*CreateUserTaskRequest)(nil),             // 12: user.service.v1.CreateUserTaskRequest
	(*DeleteUserReq)(nil),                     // 13: user.service.v1.DeleteUserReq
	(*ListUserReq)(nil),                       // 14: user.service.v1.ListUserReq
	(*BricamsGetAddonsUserReq)(nil),           // 15: user.service.v1.BricamsGetAddonsUserReq
	(*BricamsGetAddonsUserByUsernameReq)(nil), // 16: user.service.v1.BricamsGetAddonsUserByUsernameReq
	(*HealthCheckResponse)(nil),               // 17: user.service.v1.HealthCheckResponse
	(*ListUserResponse)(nil),                  // 18: user.service.v1.ListUserResponse
	(*httpbody.HttpBody)(nil),                 // 19: google.api.HttpBody
	(*ListUserWithTaskResponse)(nil),          // 20: user.service.v1.ListUserWithTaskResponse
	(*GetUserWithTaskRes)(nil),                // 21: user.service.v1.GetUserWithTaskRes
	(*CreateUserResponse)(nil),                // 22: user.service.v1.CreateUserResponse
	(*CommonResponse)(nil),                    // 23: user.service.v1.CommonResponse
	(*DeleteUserRes)(nil),                     // 24: user.service.v1.DeleteUserRes
	(*ListUserRes)(nil),                       // 25: user.service.v1.ListUserRes
	(*BricamsGetAddonsUserRes)(nil),           // 26: user.service.v1.BricamsGetAddonsUserRes
	(*BricamsGetAddonsUserByUsernameRes)(nil), // 27: user.service.v1.BricamsGetAddonsUserByUsernameRes
	(*BRICaMSSvcUserListRes)(nil),             // 28: user.service.v1.BRICaMSSvcUserListRes
	(*BRICaMSSvcUserRes)(nil),                 // 29: user.service.v1.BRICaMSSvcUserRes
}
var file_user_api_proto_depIdxs = []int32{
	...
	10, // 6: user.service.v1.ApiService.GetUserTaskByID:input_type -> user.service.v1.GetTaskByIDReq
	9,  // 7: user.service.v1.ApiService.DownloadUserTasks:input_type -> user.service.v1.ListUserWithTaskRequest
	11, // 8: user.service.v1.ApiService.CreateUser:input_type -> user.service.v1.CreateUserRequest
	12, // 9: user.service.v1.ApiService.CreateUserTask:input_type -> user.service.v1.CreateUserTaskRequest
	13, // 10: user.service.v1.ApiService.DeleteUser:input_type -> user.service.v1.DeleteUserReq
	10, // 11: user.service.v1.ApiService.SendForDeleteUserTask:input_type -> user.service.v1.GetTaskByIDReq
	14, // 12: user.service.v1.ApiService.ListUserGroup:input_type -> user.service.v1.ListUserReq
	4,  // 13: user.service.v1.ApiService.BRICaMSgetCustomer:input_type -> user.service.v1.bricamsGetCustomerReq
	15, // 14: user.service.v1.ApiService.BRICamsGetAllUser:input_type -> user.service.v1.BricamsGetAddonsUserReq
	16, // 15: user.service.v1.ApiService.BRICamsGetUserByUsername:input_type -> user.service.v1.BricamsGetAddonsUserByUsernameReq
	15, // 16: user.service.v1.ApiService.BRICaMSsvcGetUserList:input_type -> user.service.v1.BricamsGetAddonsUserReq
	16, // 17: user.service.v1.ApiService.BRICaMSsvcGetUserByUsername:input_type -> user.service.v1.BricamsGetAddonsUserByUsernameReq
	1,  // 18: user.service.v1.ApiService.CekUsernameAvaibility:input_type -> user.service.v1.CekUsernameAvaibilityReq
	17, // 19: user.service.v1.ApiService.HealthCheck:output_type -> user.service.v1.HealthCheckResponse
	18, // 20: user.service.v1.ApiService.GetUsers:output_type -> user.service.v1.ListUserResponse
	19, // 21: user.service.v1.ApiService.DownloadUsers:output_type -> google.api.HttpBody
	20, // 22: user.service.v1.ApiService.GetUserTasks:output_type -> user.service.v1.ListUserWithTaskResponse
	21, // 23: user.service.v1.ApiService.GetUserTaskByID:output_type -> user.service.v1.GetUserWithTaskRes
	19, // 24: user.service.v1.ApiService.DownloadUserTasks:output_type -> google.api.HttpBody
	22, // 25: user.service.v1.ApiService.CreateUser:output_type -> user.service.v1.CreateUserResponse
	23, // 26: user.service.v1.ApiService.CreateUserTask:output_type -> user.service.v1.CommonResponse
	24, // 27: user.service.v1.ApiService.DeleteUser:output_type -> user.service.v1.DeleteUserRes
	21, // 28: user.service.v1.ApiService.SendForDeleteUserTask:output_type -> user.service.v1.GetUserWithTaskRes
	25, // 29: user.service.v1.ApiService.ListUserGroup:output_type -> user.service.v1.ListUserRes
	5,  // 30: user.service.v1.ApiService.BRICaMSgetCustomer:output_type -> user.service.v1.bricamsGetCustomerRes
	26, // 31: user.service.v1.ApiService.BRICamsGetAllUser:output_type -> user.service.v1.BricamsGetAddonsUserRes
	27, // 32: user.service.v1.ApiService.BRICamsGetUserByUsername:output_type -> user.service.v1.BricamsGetAddonsUserByUsernameRes
	28, // 33: user.service.v1.ApiService.BRICaMSsvcGetUserList:output_type -> user.service.v1.BRICaMSSvcUserListRes
	29, // 34: user.service.v1.ApiService.BRICaMSsvcGetUserByUsername:output_type -> user.service.v1.BRICaMSSvcUserRes
	2,  // 35: user.service.v1.ApiService.CekUsernameAvaibility:output_type -> user.service.v1.CekUsernameAvaibilityRes
