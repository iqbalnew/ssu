...
type ApiServiceClient interface {
	...
	TaskActionLicense(ctx context.Context, in *TaskActionRequest, opts ...grpc.CallOption) (*TaskActionResponse, error)
}
...
func (c *apiServiceClient) TaskActionLicense(ctx context.Context, in *TaskActionRequest, opts ...grpc.CallOption) (*TaskActionResponse, error) {
	out := new(TaskActionResponse)
	err := c.cc.Invoke(ctx, "/menu.service.v1.ApiService/TaskActionLicense", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApiServiceServer interface {
	...
	TaskActionLicense(context.Context, *TaskActionRequest) (*TaskActionResponse, error)
...
func (UnimplementedApiServiceServer) TaskActionLicense(context.Context, *TaskActionRequest) (*TaskActionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TaskActionLicense not implemented")
}
...
func _ApiService_TaskActionLicense_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskActionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServiceServer).TaskActionLicense(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/menu.service.v1.ApiService/TaskActionLicense",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServiceServer).TaskActionLicense(ctx, req.(*TaskActionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApiService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TaskActionLicense",
			Handler:    _ApiService_TaskActionLicense_Handler,
		},
	},
