...
type MenuLicenseWrite struct {
	...
	Penalty         string `protobuf:"bytes,33,opt,name=penalty,proto3" json:"penalty,omitempty"`
}
...
func (x *MenuLicenseWrite) GetPenalty() string {
	if x != nil {
		return x.Penalty
	}
	return ""
...
type MenuLicenseSave struct {
	...
	Penalty         string `protobuf:"bytes,34,opt,name=penalty,proto3" json:"penalty,omitempty"`
}
...
func (x *MenuLicenseSave) GetPenalty() string {
	if x != nil {
		return x.Penalty
	}
	return ""
...
var file_menu_payload_proto_rawDesc = []byte{
	...
	0x07, 0x70, 0x65, 0x6e, 0x61, 0x6c, 0x74, 0x79, 0x18, 0x21, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	...
	0x22, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x65, 0x6e, 0x61, 0x6c, 0x74, 0x79, 0x22, 0x5d,
