...
type ApiServiceClient interface {
	...
	ChargeCompanies(ctx context.Context, in *ChargeCompaniesReq, opts ...grpc.CallOption) (*ChargeCompaniesRes, error)
...
func (c *apiServiceClient) ChargeCompanies(ctx context.Context, in *ChargeCompaniesReq, opts ...grpc.CallOption) (*ChargeCompaniesRes, error) {
	out := new(ChargeCompaniesRes)
...
type ApiServiceServer interface {
	...
	ChargeCompanies(context.Context, *ChargeCompaniesReq) (*ChargeCompaniesRes, error)
...
func (UnimplementedApiServiceServer) ChargeCompanies(context.Context, *ChargeCompaniesReq) (*ChargeCompaniesRes, error) {
...
func _ApiService_ChargeCompanies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServiceServer).ChargeCompanies(ctx, req.(*ChargeCompaniesReq))
	}
	return interceptor(ctx, in, info, handler)
}
