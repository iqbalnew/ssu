...
type ApiServiceClient interface {
	...
	GenerateBulkInvoice(ctx context.Context, in *BulkInvoiceRequest, opts ...grpc.CallOption) (*GenerateBulkInvoiceRes, error)
...
func (c *apiServiceClient) GenerateBulkInvoice(ctx context.Context, in *BulkInvoiceRequest, opts ...grpc.CallOption) (*GenerateBulkInvoiceRes, error) {
...
type ApiServiceServer interface {
	...
	GenerateBulkInvoice(context.Context, *BulkInvoiceRequest) (*GenerateBulkInvoiceRes, error)
...
func (UnimplementedApiServiceServer) GenerateBulkInvoice(context.Context, *BulkInvoiceRequest) (*GenerateBulkInvoiceRes, error) {
...
func _ApiService_GenerateBulkInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServiceServer).GenerateBulkInvoice(ctx, req.(*BulkInvoiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
