...
type DepositoServiceClient interface {
	...
	ListDeposito(ctx context.Context, in *DataListRequest, opts ...grpc.CallOption) (*DataListResponse, error)
	DepositoDetail(ctx context.Context, in *DataDetailRequest, opts ...grpc.CallOption) (*DataDetailResponse, error)
...
func (c *depositoServiceClient) ListDeposito(ctx context.Context, in *DataListRequest, opts ...grpc.CallOption) (*DataListResponse, error) {
...
func (c *depositoServiceClient) DepositoDetail(ctx context.Context, in *DataDetailRequest, opts ...grpc.CallOption) (*DataDetailResponse, error) {
...
type DepositoServiceServer interface {
	...
	ListDeposito(context.Context, *DataListRequest) (*DataListResponse, error)
	DepositoDetail(context.Context, *DataDetailRequest) (*DataDetailResponse, error)
...
func (UnimplementedDepositoServiceServer) ListDeposito(context.Context, *DataListRequest) (*DataListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListDeposito not implemented")
}
func (UnimplementedDepositoServiceServer) DepositoDetail(context.Context, *DataDetailRequest) (*DataDetailResponse, error) {
...
func _DepositoService_ListDeposito_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DepositoServiceServer).ListDeposito(ctx, req.(*DataListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DepositoService_DepositoDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DepositoServiceServer).DepositoDetail(ctx, req.(*DataDetailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
