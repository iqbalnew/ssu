...
type BeneficiaryAccountRoleORM struct {
	BeneficiaryAccountID uint64 `gorm:"column:BeneficiaryAccountID;primary_key;not null"`
	CreatedAt            *time.Time
...
// TableName overrides the default tablename generated by GORM
func (BeneficiaryAccountRoleORM) TableName() string {
	return "beneficiary_account_roles"
}

// ToORM runs the BeforeToORM hook if present, converts the fields of this
// object to ORM format, runs the AfterToORM hook, then returns the ORM object
func (m *BeneficiaryAccountRole) ToORM(ctx context.Context) (BeneficiaryAccountRoleORM, error) {
	to := BeneficiaryAccountRoleORM{}
	var err error
	if prehook, ok := interface{}(m).(BeneficiaryAccountRoleWithBeforeToORM); ok {
		if err = prehook.BeforeToORM(ctx, &to); err != nil {
			return to, err
		}
	}
	...
	if posthook, ok := interface{}(m).(BeneficiaryAccountRoleWithAfterToORM); ok {
		err = posthook.AfterToORM(ctx, &to)
	}
	return to, err
}
...
// ToPB runs the BeforeToPB hook if present, converts the fields of this
// object to PB format, runs the AfterToPB hook, then returns the PB object
func (m *BeneficiaryAccountRoleORM) ToPB(ctx context.Context) (BeneficiaryAccountRole, error) {
	to := BeneficiaryAccountRole{}
	var err error
	if prehook, ok := interface{}(m).(BeneficiaryAccountRoleWithBeforeToPB); ok {
		if err = prehook.BeforeToPB(ctx, &to); err != nil {
			return to, err
		}
	}
	...
	if posthook, ok := interface{}(m).(BeneficiaryAccountRoleWithAfterToPB); ok {
		err = posthook.AfterToPB(ctx, &to)
	}
	return to, err
}
...
// The following are interfaces you can implement for special behavior during ORM/PB conversions
// of type BeneficiaryAccountRole the arg will be the target, the caller the one being converted from

// BeneficiaryAccountRoleBeforeToORM called before default ToORM code
type BeneficiaryAccountRoleWithBeforeToORM interface {
	BeforeToORM(context.Context, *BeneficiaryAccountRoleORM) error
}

// BeneficiaryAccountRoleAfterToORM called after default ToORM code
type BeneficiaryAccountRoleWithAfterToORM interface {
	AfterToORM(context.Context, *BeneficiaryAccountRoleORM) error
}

// BeneficiaryAccountRoleBeforeToPB called before default ToPB code
type BeneficiaryAccountRoleWithBeforeToPB interface {
	BeforeToPB(context.Context, *BeneficiaryAccountRole) error
}

// BeneficiaryAccountRoleAfterToPB called after default ToPB code
type BeneficiaryAccountRoleWithAfterToPB interface {
	AfterToPB(context.Context, *BeneficiaryAccountRole) error
}
...
// DefaultCreateBeneficiaryAccountRole executes a basic gorm create call
func DefaultCreateBeneficiaryAccountRole(ctx context.Context, in *BeneficiaryAccountRole, db *gorm.DB) (*BeneficiaryAccountRole, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithBeforeCreate_); ok {
		if db, err = hook.BeforeCreate_(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithAfterCreate_); ok {
		if err = hook.AfterCreate_(ctx, db); err != nil {
			return nil, err
		}
	}
...
type BeneficiaryAccountRoleORMWithBeforeCreate_ interface {
	BeforeCreate_(context.Context, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleORMWithAfterCreate_ interface {
	AfterCreate_(context.Context, *gorm.DB) error
}

func DefaultReadBeneficiaryAccountRole(ctx context.Context, in *BeneficiaryAccountRole, db *gorm.DB) (*BeneficiaryAccountRole, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithBeforeReadApplyQuery); ok {
		if db, err = hook.BeforeReadApplyQuery(ctx, db); err != nil {
			return nil, err
		}
	}
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &BeneficiaryAccountRoleORM{}); err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithBeforeReadFind); ok {
		if db, err = hook.BeforeReadFind(ctx, db); err != nil {
			return nil, err
		}
	}
	ormResponse := BeneficiaryAccountRoleORM{}
	if err = db.Where(&ormObj).First(&ormResponse).Error; err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormResponse).(BeneficiaryAccountRoleORMWithAfterReadFind); ok {
		if err = hook.AfterReadFind(ctx, db); err != nil {
			return nil, err
		}
	}
...
type BeneficiaryAccountRoleORMWithBeforeReadApplyQuery interface {
	BeforeReadApplyQuery(context.Context, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleORMWithBeforeReadFind interface {
	BeforeReadFind(context.Context, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleORMWithAfterReadFind interface {
	AfterReadFind(context.Context, *gorm.DB) error
}

func DefaultDeleteBeneficiaryAccountRole(ctx context.Context, in *BeneficiaryAccountRole, db *gorm.DB) error {
	if in == nil {
		return errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithBeforeDelete_); ok {
		if db, err = hook.BeforeDelete_(ctx, db); err != nil {
			return err
		}
	}
	err = db.Where(&ormObj).Delete(&BeneficiaryAccountRoleORM{}).Error
	if err != nil {
		return err
	}
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithAfterDelete_); ok {
		err = hook.AfterDelete_(ctx, db)
	}
	return err
}

type BeneficiaryAccountRoleORMWithBeforeDelete_ interface {
	BeforeDelete_(context.Context, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleORMWithAfterDelete_ interface {
	AfterDelete_(context.Context, *gorm.DB) error
}

func DefaultDeleteBeneficiaryAccountRoleSet(ctx context.Context, in []*BeneficiaryAccountRole, db *gorm.DB) error {
	if in == nil {
		return errors.NilArgumentError
	}
	var err error
	...
	if hook, ok := (interface{}(&BeneficiaryAccountRoleORM{})).(BeneficiaryAccountRoleORMWithBeforeDeleteSet); ok {
		if db, err = hook.BeforeDeleteSet(ctx, in, db); err != nil {
			return err
		}
	}
	err = db.Where("beneficiary_account_id in (?)", keys).Delete(&BeneficiaryAccountRoleORM{}).Error
	if err != nil {
		return err
	}
	if hook, ok := (interface{}(&BeneficiaryAccountRoleORM{})).(BeneficiaryAccountRoleORMWithAfterDeleteSet); ok {
		err = hook.AfterDeleteSet(ctx, in, db)
	}
	return err
}

type BeneficiaryAccountRoleORMWithBeforeDeleteSet interface {
	BeforeDeleteSet(context.Context, []*BeneficiaryAccountRole, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleORMWithAfterDeleteSet interface {
	AfterDeleteSet(context.Context, []*BeneficiaryAccountRole, *gorm.DB) error
}

// DefaultStrictUpdateBeneficiaryAccountRole clears / replaces / appends first level 1:many children and then executes a gorm update call
func DefaultStrictUpdateBeneficiaryAccountRole(ctx context.Context, in *BeneficiaryAccountRole, db *gorm.DB) (*BeneficiaryAccountRole, error) {
	if in == nil {
		return nil, fmt.Errorf("Nil argument to DefaultStrictUpdateBeneficiaryAccountRole")
	}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	}
	lockedRow := &BeneficiaryAccountRoleORM{}
	db.Model(&ormObj).Set("gorm:query_option", "FOR UPDATE").Where("BeneficiaryAccountID=?", ormObj.BeneficiaryAccountID).First(lockedRow)
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithBeforeStrictUpdateCleanup); ok {
		if db, err = hook.BeforeStrictUpdateCleanup(ctx, db); err != nil {
			return nil, err
		}
	}
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithBeforeStrictUpdateSave); ok {
		if db, err = hook.BeforeStrictUpdateSave(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithAfterStrictUpdateSave); ok {
		if err = hook.AfterStrictUpdateSave(ctx, db); err != nil {
			return nil, err
		}
	}
...
type BeneficiaryAccountRoleORMWithBeforeStrictUpdateCleanup interface {
	BeforeStrictUpdateCleanup(context.Context, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleORMWithBeforeStrictUpdateSave interface {
	BeforeStrictUpdateSave(context.Context, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleORMWithAfterStrictUpdateSave interface {
	AfterStrictUpdateSave(context.Context, *gorm.DB) error
}

// DefaultPatchBeneficiaryAccountRole executes a basic gorm update call with patch behavior
func DefaultPatchBeneficiaryAccountRole(ctx context.Context, in *BeneficiaryAccountRole, updateMask *field_mask.FieldMask, db *gorm.DB) (*BeneficiaryAccountRole, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	var pbObj BeneficiaryAccountRole
	var err error
	if hook, ok := interface{}(&pbObj).(BeneficiaryAccountRoleWithBeforePatchRead); ok {
		if db, err = hook.BeforePatchRead(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
	if hook, ok := interface{}(&pbObj).(BeneficiaryAccountRoleWithBeforePatchApplyFieldMask); ok {
		if db, err = hook.BeforePatchApplyFieldMask(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
	if _, err := DefaultApplyFieldMaskBeneficiaryAccountRole(ctx, &pbObj, in, updateMask, "", db); err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&pbObj).(BeneficiaryAccountRoleWithBeforePatchSave); ok {
		if db, err = hook.BeforePatchSave(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
	pbResponse, err := DefaultStrictUpdateBeneficiaryAccountRole(ctx, &pbObj, db)
	if err != nil {
		return nil, err
	}
	if hook, ok := interface{}(pbResponse).(BeneficiaryAccountRoleWithAfterPatchSave); ok {
		if err = hook.AfterPatchSave(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
...
type BeneficiaryAccountRoleWithBeforePatchRead interface {
	BeforePatchRead(context.Context, *BeneficiaryAccountRole, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleWithBeforePatchApplyFieldMask interface {
	BeforePatchApplyFieldMask(context.Context, *BeneficiaryAccountRole, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleWithBeforePatchSave interface {
	BeforePatchSave(context.Context, *BeneficiaryAccountRole, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleWithAfterPatchSave interface {
	AfterPatchSave(context.Context, *BeneficiaryAccountRole, *field_mask.FieldMask, *gorm.DB) error
}

// DefaultPatchSetBeneficiaryAccountRole executes a bulk gorm update call with patch behavior
func DefaultPatchSetBeneficiaryAccountRole(ctx context.Context, objects []*BeneficiaryAccountRole, updateMasks []*field_mask.FieldMask, db *gorm.DB) ([]*BeneficiaryAccountRole, error) {
	if len(objects) != len(updateMasks) {
		return nil, fmt.Errorf(errors.BadRepeatedFieldMaskTpl, len(updateMasks), len(objects))
	}

	results := make([]*BeneficiaryAccountRole, 0, len(objects))
	for i, patcher := range objects {
		pbResponse, err := DefaultPatchBeneficiaryAccountRole(ctx, patcher, updateMasks[i], db)
		if err != nil {
			return nil, err
		}
...
// DefaultApplyFieldMaskBeneficiaryAccountRole patches an pbObject with patcher according to a field mask.
func DefaultApplyFieldMaskBeneficiaryAccountRole(ctx context.Context, patchee *BeneficiaryAccountRole, patcher *BeneficiaryAccountRole, updateMask *field_mask.FieldMask, prefix string, db *gorm.DB) (*BeneficiaryAccountRole, error) {
	if patcher == nil {
		return nil, nil
	} else if patchee == nil {
		return nil, errors.NilArgumentError
...
// DefaultListBeneficiaryAccountRole executes a gorm list call
func DefaultListBeneficiaryAccountRole(ctx context.Context, db *gorm.DB) ([]*BeneficiaryAccountRole, error) {
	in := BeneficiaryAccountRole{}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithBeforeListApplyQuery); ok {
		if db, err = hook.BeforeListApplyQuery(ctx, db); err != nil {
			return nil, err
		}
	}
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &BeneficiaryAccountRoleORM{}, &BeneficiaryAccountRole{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithBeforeListFind); ok {
		if db, err = hook.BeforeListFind(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(BeneficiaryAccountRoleORMWithAfterListFind); ok {
		if err = hook.AfterListFind(ctx, db, &ormResponse); err != nil {
			return nil, err
		}
	}
	pbResponse := []*BeneficiaryAccountRole{}
	for _, responseEntry := range ormResponse {
		temp, err := responseEntry.ToPB(ctx)
		if err != nil {
			return nil, err
...
type BeneficiaryAccountRoleORMWithBeforeListApplyQuery interface {
	BeforeListApplyQuery(context.Context, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleORMWithBeforeListFind interface {
	BeforeListFind(context.Context, *gorm.DB) (*gorm.DB, error)
}
type BeneficiaryAccountRoleORMWithAfterListFind interface {
	AfterListFind(context.Context, *gorm.DB, *[]BeneficiaryAccountRoleORM) error
}
