...
type PayrollTransferItemORM struct {
...
// TableName overrides the default tablename generated by GORM
func (PayrollTransferItemORM) TableName() string {
	return "payroll_transfer_items"
}

// ToORM runs the BeforeToORM hook if present, converts the fields of this
// object to ORM format, runs the AfterToORM hook, then returns the ORM object
func (m *PayrollTransferItem) ToORM(ctx context.Context) (PayrollTransferItemORM, error) {
	to := PayrollTransferItemORM{}
	var err error
	if prehook, ok := interface{}(m).(PayrollTransferItemWithBeforeToORM); ok {
		if err = prehook.BeforeToORM(ctx, &to); err != nil {
			return to, err
		}
	}
	...
	if posthook, ok := interface{}(m).(PayrollTransferItemWithAfterToORM); ok {
		err = posthook.AfterToORM(ctx, &to)
	}
	return to, err
}
...
// ToPB runs the BeforeToPB hook if present, converts the fields of this
// object to PB format, runs the AfterToPB hook, then returns the PB object
func (m *PayrollTransferItemORM) ToPB(ctx context.Context) (PayrollTransferItem, error) {
	to := PayrollTransferItem{}
	var err error
	if prehook, ok := interface{}(m).(PayrollTransferItemWithBeforeToPB); ok {
		if err = prehook.BeforeToPB(ctx, &to); err != nil {
			return to, err
		}
	}
	...
	if posthook, ok := interface{}(m).(PayrollTransferItemWithAfterToPB); ok {
		err = posthook.AfterToPB(ctx, &to)
	}
	return to, err
}
...
// The following are interfaces you can implement for special behavior during ORM/PB conversions
// of type PayrollTransferItem the arg will be the target, the caller the one being converted from

// PayrollTransferItemBeforeToORM called before default ToORM code
type PayrollTransferItemWithBeforeToORM interface {
	BeforeToORM(context.Context, *PayrollTransferItemORM) error
}

// PayrollTransferItemAfterToORM called after default ToORM code
type PayrollTransferItemWithAfterToORM interface {
	AfterToORM(context.Context, *PayrollTransferItemORM) error
}

// PayrollTransferItemBeforeToPB called before default ToPB code
type PayrollTransferItemWithBeforeToPB interface {
	BeforeToPB(context.Context, *PayrollTransferItem) error
}

// PayrollTransferItemAfterToPB called after default ToPB code
type PayrollTransferItemWithAfterToPB interface {
	AfterToPB(context.Context, *PayrollTransferItem) error
}
...
// DefaultCreatePayrollTransferItem executes a basic gorm create call
func DefaultCreatePayrollTransferItem(ctx context.Context, in *PayrollTransferItem, db *gorm.DB) (*PayrollTransferItem, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithBeforeCreate_); ok {
		if db, err = hook.BeforeCreate_(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithAfterCreate_); ok {
		if err = hook.AfterCreate_(ctx, db); err != nil {
			return nil, err
		}
	}
...
type PayrollTransferItemORMWithBeforeCreate_ interface {
	BeforeCreate_(context.Context, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemORMWithAfterCreate_ interface {
	AfterCreate_(context.Context, *gorm.DB) error
}

func DefaultReadPayrollTransferItem(ctx context.Context, in *PayrollTransferItem, db *gorm.DB) (*PayrollTransferItem, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithBeforeReadApplyQuery); ok {
		if db, err = hook.BeforeReadApplyQuery(ctx, db); err != nil {
			return nil, err
		}
	}
	if db, err = gorm1.ApplyFieldSelection(ctx, db, nil, &PayrollTransferItemORM{}); err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithBeforeReadFind); ok {
		if db, err = hook.BeforeReadFind(ctx, db); err != nil {
			return nil, err
		}
	}
	ormResponse := PayrollTransferItemORM{}
	if err = db.Where(&ormObj).First(&ormResponse).Error; err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormResponse).(PayrollTransferItemORMWithAfterReadFind); ok {
		if err = hook.AfterReadFind(ctx, db); err != nil {
			return nil, err
		}
	}
...
type PayrollTransferItemORMWithBeforeReadApplyQuery interface {
	BeforeReadApplyQuery(context.Context, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemORMWithBeforeReadFind interface {
	BeforeReadFind(context.Context, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemORMWithAfterReadFind interface {
	AfterReadFind(context.Context, *gorm.DB) error
}

func DefaultDeletePayrollTransferItem(ctx context.Context, in *PayrollTransferItem, db *gorm.DB) error {
	if in == nil {
		return errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithBeforeDelete_); ok {
		if db, err = hook.BeforeDelete_(ctx, db); err != nil {
			return err
		}
	}
	err = db.Where(&ormObj).Delete(&PayrollTransferItemORM{}).Error
	if err != nil {
		return err
	}
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithAfterDelete_); ok {
		err = hook.AfterDelete_(ctx, db)
	}
	return err
}

type PayrollTransferItemORMWithBeforeDelete_ interface {
	BeforeDelete_(context.Context, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemORMWithAfterDelete_ interface {
	AfterDelete_(context.Context, *gorm.DB) error
}

func DefaultDeletePayrollTransferItemSet(ctx context.Context, in []*PayrollTransferItem, db *gorm.DB) error {
	if in == nil {
		return errors.NilArgumentError
	}
	var err error
	...
	if hook, ok := (interface{}(&PayrollTransferItemORM{})).(PayrollTransferItemORMWithBeforeDeleteSet); ok {
		if db, err = hook.BeforeDeleteSet(ctx, in, db); err != nil {
			return err
		}
	}
	err = db.Where("id in (?)", keys).Delete(&PayrollTransferItemORM{}).Error
	if err != nil {
		return err
	}
	if hook, ok := (interface{}(&PayrollTransferItemORM{})).(PayrollTransferItemORMWithAfterDeleteSet); ok {
		err = hook.AfterDeleteSet(ctx, in, db)
	}
	return err
}

type PayrollTransferItemORMWithBeforeDeleteSet interface {
	BeforeDeleteSet(context.Context, []*PayrollTransferItem, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemORMWithAfterDeleteSet interface {
	AfterDeleteSet(context.Context, []*PayrollTransferItem, *gorm.DB) error
}

// DefaultStrictUpdatePayrollTransferItem clears / replaces / appends first level 1:many children and then executes a gorm update call
func DefaultStrictUpdatePayrollTransferItem(ctx context.Context, in *PayrollTransferItem, db *gorm.DB) (*PayrollTransferItem, error) {
	if in == nil {
		return nil, fmt.Errorf("Nil argument to DefaultStrictUpdatePayrollTransferItem")
	}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	}
	lockedRow := &PayrollTransferItemORM{}
	db.Model(&ormObj).Set("gorm:query_option", "FOR UPDATE").Where("id=?", ormObj.Id).First(lockedRow)
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithBeforeStrictUpdateCleanup); ok {
		if db, err = hook.BeforeStrictUpdateCleanup(ctx, db); err != nil {
			return nil, err
		}
	}
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithBeforeStrictUpdateSave); ok {
		if db, err = hook.BeforeStrictUpdateSave(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithAfterStrictUpdateSave); ok {
		if err = hook.AfterStrictUpdateSave(ctx, db); err != nil {
			return nil, err
		}
	}
...
type PayrollTransferItemORMWithBeforeStrictUpdateCleanup interface {
	BeforeStrictUpdateCleanup(context.Context, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemORMWithBeforeStrictUpdateSave interface {
	BeforeStrictUpdateSave(context.Context, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemORMWithAfterStrictUpdateSave interface {
	AfterStrictUpdateSave(context.Context, *gorm.DB) error
}

// DefaultPatchPayrollTransferItem executes a basic gorm update call with patch behavior
func DefaultPatchPayrollTransferItem(ctx context.Context, in *PayrollTransferItem, updateMask *field_mask.FieldMask, db *gorm.DB) (*PayrollTransferItem, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	var pbObj PayrollTransferItem
	var err error
	if hook, ok := interface{}(&pbObj).(PayrollTransferItemWithBeforePatchRead); ok {
		if db, err = hook.BeforePatchRead(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
	pbReadRes, err := DefaultReadPayrollTransferItem(ctx, &PayrollTransferItem{Id: in.GetId()}, db)
	if err != nil {
		return nil, err
	}
	pbObj = *pbReadRes
	if hook, ok := interface{}(&pbObj).(PayrollTransferItemWithBeforePatchApplyFieldMask); ok {
		if db, err = hook.BeforePatchApplyFieldMask(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
	if _, err := DefaultApplyFieldMaskPayrollTransferItem(ctx, &pbObj, in, updateMask, "", db); err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&pbObj).(PayrollTransferItemWithBeforePatchSave); ok {
		if db, err = hook.BeforePatchSave(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
	pbResponse, err := DefaultStrictUpdatePayrollTransferItem(ctx, &pbObj, db)
	if err != nil {
		return nil, err
	}
	if hook, ok := interface{}(pbResponse).(PayrollTransferItemWithAfterPatchSave); ok {
		if err = hook.AfterPatchSave(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
...
type PayrollTransferItemWithBeforePatchRead interface {
	BeforePatchRead(context.Context, *PayrollTransferItem, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemWithBeforePatchApplyFieldMask interface {
	BeforePatchApplyFieldMask(context.Context, *PayrollTransferItem, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemWithBeforePatchSave interface {
	BeforePatchSave(context.Context, *PayrollTransferItem, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemWithAfterPatchSave interface {
	AfterPatchSave(context.Context, *PayrollTransferItem, *field_mask.FieldMask, *gorm.DB) error
}

// DefaultPatchSetPayrollTransferItem executes a bulk gorm update call with patch behavior
func DefaultPatchSetPayrollTransferItem(ctx context.Context, objects []*PayrollTransferItem, updateMasks []*field_mask.FieldMask, db *gorm.DB) ([]*PayrollTransferItem, error) {
	if len(objects) != len(updateMasks) {
		return nil, fmt.Errorf(errors.BadRepeatedFieldMaskTpl, len(updateMasks), len(objects))
	}

	results := make([]*PayrollTransferItem, 0, len(objects))
	for i, patcher := range objects {
		pbResponse, err := DefaultPatchPayrollTransferItem(ctx, patcher, updateMasks[i], db)
		if err != nil {
			return nil, err
		}
...
// DefaultApplyFieldMaskPayrollTransferItem patches an pbObject with patcher according to a field mask.
func DefaultApplyFieldMaskPayrollTransferItem(ctx context.Context, patchee *PayrollTransferItem, patcher *PayrollTransferItem, updateMask *field_mask.FieldMask, prefix string, db *gorm.DB) (*PayrollTransferItem, error) {
	if patcher == nil {
		return nil, nil
	} else if patchee == nil {
		return nil, errors.NilArgumentError
...
// DefaultListPayrollTransferItem executes a gorm list call
func DefaultListPayrollTransferItem(ctx context.Context, db *gorm.DB) ([]*PayrollTransferItem, error) {
	in := PayrollTransferItem{}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithBeforeListApplyQuery); ok {
		if db, err = hook.BeforeListApplyQuery(ctx, db); err != nil {
			return nil, err
		}
	}
	db, err = gorm1.ApplyCollectionOperators(ctx, db, &PayrollTransferItemORM{}, &PayrollTransferItem{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithBeforeListFind); ok {
		if db, err = hook.BeforeListFind(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(PayrollTransferItemORMWithAfterListFind); ok {
		if err = hook.AfterListFind(ctx, db, &ormResponse); err != nil {
			return nil, err
		}
	}
	pbResponse := []*PayrollTransferItem{}
	for _, responseEntry := range ormResponse {
		temp, err := responseEntry.ToPB(ctx)
		if err != nil {
			return nil, err
...
type PayrollTransferItemORMWithBeforeListApplyQuery interface {
	BeforeListApplyQuery(context.Context, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemORMWithBeforeListFind interface {
	BeforeListFind(context.Context, *gorm.DB) (*gorm.DB, error)
}
type PayrollTransferItemORMWithAfterListFind interface {
	AfterListFind(context.Context, *gorm.DB, *[]PayrollTransferItemORM) error
}
