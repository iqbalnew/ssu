...
type ApiServiceClient interface {
	...
	RunCreateMassTransferJob(ctx context.Context, in *RunCreateMassTransferJobRequest, opts ...grpc.CallOption) (*RunCreateMassTransferJobResponse, error)
}
...
func (c *apiServiceClient) CancelTransferPayroll(ctx context.Context, in *CancelTransferPayrollRequest, opts ...grpc.CallOption) (*CancelTransferPayrollResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/payroll.service.v1.ApiService/CancelTransferPayroll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiServiceClient) RunFileCheckingPayrollJob(ctx context.Context, in *RunFileCheckingPayrollJobRequest, opts ...grpc.CallOption) (*RunFileCheckingPayrollJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/payroll.service.v1.ApiService/RunFileCheckingPayrollJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiServiceClient) RunMassInquiryJob(ctx context.Context, in *RunMassInquiryJobRequest, opts ...grpc.CallOption) (*RunMassInquiryJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/payroll.service.v1.ApiService/RunMassInquiryJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiServiceClient) RunMassTransferJob(ctx context.Context, in *RunMassTransferJobRequest, opts ...grpc.CallOption) (*RunMassTransferJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/payroll.service.v1.ApiService/RunMassTransferJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiServiceClient) RunCreateMassTransferJob(ctx context.Context, in *RunCreateMassTransferJobRequest, opts ...grpc.CallOption) (*RunCreateMassTransferJobResponse, error) {
	out := new(RunCreateMassTransferJobResponse)
	err := c.cc.Invoke(ctx, "/payroll.service.v1.ApiService/RunCreateMassTransferJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApiServiceServer interface {
	...
	RunCreateMassTransferJob(context.Context, *RunCreateMassTransferJobRequest) (*RunCreateMassTransferJobResponse, error)
...
func (UnimplementedApiServiceServer) RunCreateMassTransferJob(context.Context, *RunCreateMassTransferJobRequest) (*RunCreateMassTransferJobResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RunCreateMassTransferJob not implemented")
}
...
func _ApiService_CancelTransferPayroll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payroll.service.v1.ApiService/CancelTransferPayroll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiService_RunFileCheckingPayrollJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payroll.service.v1.ApiService/RunFileCheckingPayrollJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiService_RunMassInquiryJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payroll.service.v1.ApiService/RunMassInquiryJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiService_RunMassTransferJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payroll.service.v1.ApiService/RunMassTransferJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiService_RunCreateMassTransferJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunCreateMassTransferJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApiServiceServer).RunCreateMassTransferJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/payroll.service.v1.ApiService/RunCreateMassTransferJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServiceServer).RunCreateMassTransferJob(ctx, req.(*RunCreateMassTransferJobRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApiService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RunCreateMassTransferJob",
			Handler:    _ApiService_RunCreateMassTransferJob_Handler,
		},
	},
